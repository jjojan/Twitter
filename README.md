# Project 2 - *Twitter 2.0*

**Twitter 2.0* is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] Added bottom toolbar
* [x] Added laucher icon

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='[https://imgur.com/uM2PYct](https://i.imgur.com/uM2PYct.gifv)' title='Video Walkthrough' width='' alt='Video Walkthrough' />
